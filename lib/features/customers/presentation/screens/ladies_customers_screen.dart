...
class LadiesCustomersScreen extends StatefulWidget {
  const LadiesCustomersScreen({super.key});

  @override
  State<LadiesCustomersScreen> createState() => _LadiesCustomersScreenState();
}

class _LadiesCustomersScreenState extends State<LadiesCustomersScreen>
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Manage all ladies tailoring profiles',
                style: TextStyle(
                  color: secondaryText,
                  fontSize: 11,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 5),
                const Text(
                  'Organized customer profiles with a smooth premium view.',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 12,
                    height: 1.4,
