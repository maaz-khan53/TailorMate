...
class KidsCustomersScreen extends StatefulWidget {
  const KidsCustomersScreen({super.key});

  @override
  State<KidsCustomersScreen> createState() => _KidsCustomersScreenState();
}

class _KidsCustomersScreenState extends State<KidsCustomersScreen>
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Manage all kids tailoring profiles',
                style: TextStyle(
                  color: secondaryText,
                  fontSize: 11,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 5),
                const Text(
                  'Simple and clear access to kids measurements and details.',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 12,
                    height: 1.4,
