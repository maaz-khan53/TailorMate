...
class _AnimatedDressMeasurementCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Do not animate every large measurement card while the page route is
    // also animating. This keeps profile open/back transitions smooth.
                        ...
                        LayoutBuilder(
                          builder: (
                            ...
                            return Wrap(
                              spacing: gap,
                              runSpacing: gap,
                              children: _controllers.entries.map(
